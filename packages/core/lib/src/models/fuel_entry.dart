...
class FuelEntry {
  ...
  double get totalCost =>
      (fuelQuantity * pricePerUnit) + (defQuantity * defPrice);
  ...
  factory FuelEntry.fromJson(Map<String, dynamic> json) {
    return FuelEntry(
      ...
      defQuantity: (json['def_quantity'] as num?)?.toDouble() ?? 0.0,
      defPrice: (json['def_price'] as num?)?.toDouble() ?? 0.0,
      defFromYard: json['def_from_yard'] as bool? ?? false,
  ...
  FuelEntry copyWith({
    ...
    return FuelEntry(
      ...
      defPrice: defPrice ?? this.defPrice,
